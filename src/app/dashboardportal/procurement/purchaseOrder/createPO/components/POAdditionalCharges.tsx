...
import type { AdditionalChargeOption, POAdditionalCharge } from "../types/poTypes";

type POAdditionalChargesProps = {
	charges: POAdditionalCharge[];
	options: AdditionalChargeOption[];
	canEdit: boolean;
	onAddCharge: () => void;
	onRemoveCharge: (id: string) => void;
	onChargeChange: (id: string, field: keyof POAdditionalCharge, value: unknown) => void;
};
...
/**
 * Additional Charges section component for PO.
 * Uses same grid-based layout as line items for visual consistency.
 */
export const POAdditionalCharges: React.FC<POAdditionalChargesProps> = ({
	charges,
	options,
	canEdit,
	onAddCharge,

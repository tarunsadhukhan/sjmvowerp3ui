...
import type { IndentReportRow } from "../types/reportTypes";
...
const columns: GridColDef[] = [
  ...
  {
    field: "indent_qty",
    headerName: "Indent Qty",
    minWidth: 110,
    type: "number",
    renderCell: (params) => fmtQty(params.value),
  },
  {
    field: "po_consumed_qty",
    headerName: "PO Consumed",
    minWidth: 120,
    type: "number",
    renderCell: (params) => fmtQty(params.value),
  },
  ...
  { field: "indent_type_id", headerName: "Indent Type", minWidth: 110 },
  { field: "expense_type_name", headerName: "Expense Type", minWidth: 130 },
  {
    field: "status_name",
    headerName: "Status",
    minWidth: 120,
...
interface IndentItemwiseReportProps {
  rows: IndentReportRow[];
  rowCount: number;
  loading: boolean;
...
export default function IndentItemwiseReport({
  rows,
  rowCount,
  loading,
  paginationModel,
  onPaginationModelChange,
}: IndentItemwiseReportProps) {
  return (
    <DataGrid
      rows={rows}
      columns={columns}
      getRowId={(row) => row.indent_dtl_id}
      rowCount={rowCount}
      loading={loading}

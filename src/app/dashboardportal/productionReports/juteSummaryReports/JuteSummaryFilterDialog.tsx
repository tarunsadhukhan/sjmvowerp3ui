...
export type JuteSummaryFilterValues = {
	fromDate: string;
	toDate: string;
};
...
type Props = {
	open: boolean;
	onClose: () => void;
	onApply: (values: JuteSummaryFilterValues) => void;
	initial?: Partial<JuteSummaryFilterValues>;
	title?: string;
};

export default function JuteSummaryFilterDialog({
	open,
	onClose,
	onApply,
	initial,

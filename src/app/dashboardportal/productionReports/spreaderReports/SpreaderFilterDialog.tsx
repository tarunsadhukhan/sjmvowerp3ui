...
export type SpreaderFilterValues = {
	fromDate: string;
	toDate: string;
};
...
type Props = {
	open: boolean;
	onClose: () => void;
	onApply: (values: SpreaderFilterValues) => void;
	initial?: Partial<SpreaderFilterValues>;
	title?: string;
};

export default function SpreaderFilterDialog({
	open,
	onClose,
	onApply,
	initial,
